...
from Mai.utils.database import get_authuser_names, get_cmode
from Mai.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Mai.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Eren.stop_stream(message.chat.id)
    except:
        pass
