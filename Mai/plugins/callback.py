...
from Mai.misc import SUDOERS, db
from Mai.utils import bot_sys_stats
...
from Mai.utils.formatters import seconds_to_min
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Eren.pause_stream(chat_id)
        ...
        await Eren.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
