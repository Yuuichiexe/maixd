...
import config
from Mai import Carbon, YouTube, app
from Mai.core.call import Eren
from Mai.misc import db
from Mai.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from Mai.utils.exceptions import AssistantErr
from Mai.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from Mai.utils.inline.playlist import close_markup
from Mai.utils.pastebin import Erenbin
from Mai.utils.stream.queue import put_queue, put_queue_index
from Mai.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Eren.force_stop_stream(chat_id)
